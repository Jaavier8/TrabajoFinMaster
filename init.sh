...
tmux new-session -d -s webhookserver 'docker run -p 1080:1080 ghcr.io/timoglastra/acapy-development-webhook-server'
...
tmux new-session -d -s police 'CONTAINER_NAME="police" PORTS="5000:5000 10000:10000" ~/OneDrive/Escritorio/TFM/aries-cloudagent-python/scripts/run_docker start --inbound-transport http 0.0.0.0 10000 --outbound-transport http -e http://host.docker.internal:10000 --genesis-url http://host.docker.internal:9000/genesis --webhook-url http://host.docker.internal:1080 --admin 0.0.0.0 5000 --admin-insecure-mode --auto-ping-connection --wallet-type indy --wallet-name test --wallet-key 1234 --auto-provision -l police --auto-accept-requests --seed uFQbs70HJ4v85EODhcJl3xN9YqtrpVnT --tails-server-base-url '"$url"''
tmux new-session -d -s academy 'CONTAINER_NAME="academy" PORTS="5001:5001 10001:10001" ~/OneDrive/Escritorio/TFM/aries-cloudagent-python/scripts/run_docker start --inbound-transport http 0.0.0.0 10001 --outbound-transport http -e http://host.docker.internal:10001 --genesis-url http://host.docker.internal:9000/genesis --webhook-url http://host.docker.internal:1080 --admin 0.0.0.0 5001 --admin-insecure-mode --auto-ping-connection --wallet-type indy --wallet-name test --wallet-key 1234 --auto-provision -l academy --auto-accept-requests --seed Kz4eN6cHxGpR3wMjQnT2vWuYz5A8sBfE --tails-server-base-url '"$url"''
tmux new-session -d -s university 'CONTAINER_NAME="university" PORTS="5002:5002 10002:10002" ~/OneDrive/Escritorio/TFM/aries-cloudagent-python/scripts/run_docker start --inbound-transport http 0.0.0.0 10002 --outbound-transport http -e http://host.docker.internal:10002 --genesis-url http://host.docker.internal:9000/genesis --webhook-url http://host.docker.internal:1080 --admin 0.0.0.0 5002 --admin-insecure-mode --auto-ping-connection --wallet-type indy --wallet-name test --wallet-key 1234 --auto-provision -l university --auto-accept-requests --seed Pd7rV0tZy3HkU6mDjSgXqAbEf1CwI9oN --tails-server-base-url '"$url"''
tmux new-session -d -s holder 'CONTAINER_NAME="holder" PORTS="7000:7000 11000:11000" ~/OneDrive/Escritorio/TFM/aries-cloudagent-python/scripts/run_docker start --inbound-transport http 0.0.0.0 11000 --outbound-transport http -e http://host.docker.internal:11000 --genesis-url http://host.docker.internal:9000/genesis --webhook-url http://host.docker.internal:1080 --admin 0.0.0.0 7000 --admin-insecure-mode --auto-ping-connection --wallet-type indy --wallet-name test --wallet-key 1234 --auto-provision -l holder --auto-accept-invites --tails-server-base-url '"$url"''
tmux new-session -d -s verifier 'CONTAINER_NAME="verifier" PORTS="7070:7070 11010:11010" ~/OneDrive/Escritorio/TFM/aries-cloudagent-python/scripts/run_docker start --inbound-transport http 0.0.0.0 11010 --outbound-transport http -e http://host.docker.internal:11010 --genesis-url http://host.docker.internal:9000/genesis --webhook-url http://host.docker.internal:1080 --admin 0.0.0.0 7070 --admin-insecure-mode --auto-ping-connection --wallet-type indy --wallet-name test --wallet-key 1234 --auto-provision -l verifier --auto-accept-requests --tails-server-base-url '"$url"''
...
tmux new-session -d -s createacademyschema 'curl -X POST -H "Content-Type: application/json" -d "{\"attributes\":[\"language\",\"languageid\",\"score\"],\"schema_name\":\"certificate\",\"schema_version\":\"0.1\"}" "http://localhost:5001/schemas"'
tmux new-session -d -s createuniversityschema 'curl -X POST -H "Content-Type: application/json" -d "{\"attributes\":[\"degree\",\"degreeid\",\"school\",\"schoolid\",\"finalgrade\"],\"schema_name\":\"degree\",\"schema_version\":\"0.1\"}" "http://localhost:5002/schemas"'
