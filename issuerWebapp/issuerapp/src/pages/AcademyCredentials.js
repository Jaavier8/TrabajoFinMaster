...
export default function AcademyCredentials(props) {
  ...
  useEffect(() => {
    async function getCredentials() {
      ...
      const academyCredentials = localStorage.getItem("academyCredentials");
      setCredentials(JSON.parse(academyCredentials) || []);
  ...
  const revokeCredential = async (index) => {
    const deleteReq = await fetch(`${ACADEMY_ISSUER}/revocation/revoke`, {
      method: "POST",
      headers: {
